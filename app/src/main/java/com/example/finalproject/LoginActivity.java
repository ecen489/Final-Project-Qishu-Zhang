...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener,WordFragment.OnInputListener{
    ...
    String[] scoresAccounts = {"QISHUZHANG@GMAIL.COM - 12", "HI@CO.UK - 4", "TEST@TAMU.EDU - 3", "T@TA.DA - 1", "Z@TAM.EDU - 1"};
...
//                            startActivity(intent);
    ...
    public void StartClk(View view) {
        ...
        if(key_word == null){
            ...
            Intent forwardIntent = new Intent(LoginActivity.this,GameActivity.class);
